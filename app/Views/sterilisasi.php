    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <?= form_open('sterilisasi/tambah-steril') ?>
                    <div class="col mb-3">
                ...
                <div class="row g-2">
                    <div>
                        <label for="exampleFormControlTextarea1" class="form-label">Cara Sterilisasi</label>
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="cara_steril"></textarea>
                    </div>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-4">
                ...
                <h5 class="card-header">Tabel Cara Sterilisasi Ikan</h5>
                                ...
                                <div class="modal fade" id="modalEdit<?= $row['id'] ?>" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    <?= form_open('sterilisasi/edit-steril') ?>
                                                    <div class="col mb-3">
                                                ...
                                                <div class="row g-2">
                                                    <div>
                                                        <label for="exampleFormControlTextarea1" class="form-label">Cara Sterilisasi</label>
                                                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="cara_steril"><?= $row['cara_sterilisasi'] ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="modal-footer">
                                ...
                                <div class="modal fade" id="modalHapus<?= $row['id'] ?>" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <?= form_open('sterilisasi/hapus-steril/' . $row['id']) ?>
