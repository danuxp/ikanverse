...
<div class="container-fluid bg-light py-5">
    <div class="col-md-6 m-auto text-center">
        <h1 class="h1">Berkembang Biak</h1>
        <p>
            Cara berkembang biak berbagai macam ikan.
        </p>
    </div>

    <?php
    foreach ($berkembang_biak as $row) {
    ?>
        <div class="col-md-3">
    ...
    <?= $pager->links('berkembang_biak', 'data_pagination') ?>
</div>
<?= $this->endSection() ?>