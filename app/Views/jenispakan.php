    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <?= form_open('jenis-pakan/tambah-pakan') ?>
                    <div class="col mb-3">
                ...
                <div class="row g-2">
                    <div>
                        <label for="exampleFormControlTextarea1" class="form-label">Pakan</label>
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="pakan"></textarea>
                    </div>
                </div>
            </div>
                                ...
                                <div class="modal fade" id="modalEdit<?= $row['id'] ?>" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    <?= form_open('jenis-pakan/edit-pakan') ?>
                                                    <div class="col mb-3">
                                                ...
                                                <div class="row g-2">
                                                    <div>
                                                        <label for="exampleFormControlTextarea1" class="form-label">Cara Budidaya</label>
                                                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="pakan"><?= $row['cara_jenispakan'] ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="modal-footer">
                                ...
                                <div class="modal fade" id="modalHapus<?= $row['id'] ?>" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <?= form_open('jenis-pakan/hapus-pakan/' . $row['id']) ?>
