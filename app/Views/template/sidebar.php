...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="<?= base_url('#') ?>" class="app-brand-link">
            ...
            <!-- <span class="app-brand-text demo menu-text fw-bolder text-primary">Ikan Verse</span> -->
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Account Settings">Budidaya</div>
            </a>
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="<?= base_url('budidaya') ?>" class="menu-link">
                        <div data-i18n="Account">Cara Budidaya</div>
                    </a>
                </li>
                <li class="menu-item">
                ...
                <li class="menu-item">
                    <a href="<?= base_url('sterilisasi') ?>" class="menu-link">
                        <div data-i18n="Connections">Sterilisasi</div>
                    </a>
                </li>
                <li class="menu-item">
        ...
        <li class="menu-item">
            <a href="<?= base_url('jualbeli') ?>" class="menu-link">
                <i class="menu-icon tf-icons bx bx-money"></i>
                <div data-i18n="Analytics">Jual Beli</div>
            </a>
        </li>
