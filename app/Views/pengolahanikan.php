    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <?= form_open('pengolahan/tambah-pengolahan') ?>
                    <div class="col mb-3">
                ...
                <div class="row g-2">
                    <div>
                        ...
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="cara_pengolahan"></textarea>
                    </div>
                </div>
            </div>
                                ...
                                <div class="modal fade" id="modalEdit<?= $row['id'] ?>" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    <?= form_open('pengolahan/edit-pengolahan') ?>
                                                    <div class="col mb-3">
                                                ...
                                                <div class="row g-2">
                                                    <div>
                                                        <label for="exampleFormControlTextarea1" class="form-label">Cara Pengolahan</label>
                                                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="cara_pengolahan"><?= $row['cara_pengolahan'] ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="modal-footer">
                                ...
                                <div class="modal fade" id="modalHapus<?= $row['id'] ?>" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <?= form_open('pengolahan/hapus-pengolahan/' . $row['id']) ?>
