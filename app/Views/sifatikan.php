    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <?= form_open('sifat-ikan/tambah-sifatikan') ?>
                    <div class="col mb-3">
                ...
                <div class="row g-2">
                    <div>
                        ...
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="sifatikan"></textarea>
                    </div>
                </div>
            </div>
                                ...
                                <div class="modal fade" id="modalEdit<?= $row['id'] ?>" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    <?= form_open('sifat-ikan/edit-sifatikan') ?>
                                                    <div class="col mb-3">
                                ...
                                <div class="modal fade" id="modalHapus<?= $row['id'] ?>" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <?= form_open('sifat-ikan/hapus-sifatikan/' . $row['id']) ?>
