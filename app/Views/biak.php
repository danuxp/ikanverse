    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <?= form_open('berkembang-biak/tambah-berkembangbiak') ?>
                    <div class="col mb-3">
                ...
                <div class="row g-2">
                    <div>
                        <label for="exampleFormControlTextarea1" class="form-label">Cara Berkembang Biak</label>
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="cara_berkembangbiak"></textarea>
                    </div>
                </div>
            </div>
...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Budidaya /</span> <?= $judul ?> </h4>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-4">
                ...
                <h5 class="card-header">Tabel Cara Berkembang Biak Ikan</h5>
                                ...
                                <div class="modal fade" id="modalEdit<?= $row['id'] ?>" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    <?= form_open('berkembang-biak/edit-berkembangbiak') ?>
                                                    <div class="col mb-3">
                                                ...
                                                <div class="row g-2">
                                                    <div>
                                                        <label for="exampleFormControlTextarea1" class="form-label">Cara Berkembang Biak</label>
                                                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="cara_berkembangbiak"><?= $row['cara_berkembangbiak'] ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="modal-footer">
                                ...
                                <div class="modal fade" id="modalHapus<?= $row['id'] ?>" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <?= form_open('berkembang-biak/hapus-berkembangbiak/' . $row['id']) ?>
